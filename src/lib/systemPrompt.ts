...
- **Backend:** Java (7.5 yr — continuous throughout entire career, including 3.3 yr at Octane in parallel with Python) · Python (3.7 yr — including 3.3 yr at Octane in parallel with Java) · Django (3.3 yr) · Spring Boot (5 yr) · Spring MVC (1.7 yr) · Spring Security (5 yr) · Hibernate / JPA (1.7 yr) · Node.js · Maven (1.7 yr) · JUnit (1.7 yr) · Mockito (1.7 yr) · REST (4 mån) · JSON (5.5 yr) · XML (1.7 yr) · Webhooks · SAML · OAuth2 · Asynchronous messaging · Apache Kafka · Event-driven Architecture
...
### 1. Consid - Systems Developer / Fullstack Developer (Mar 2026 – Present · Malmö)
...
### 2. Devoteam - Fullstack Developer (Oct 2025 – Mar 2026 · Malmö)
...
### 3. Hulo Consulting AB / Octane (USA) - Developer → Tech Lead, Fintech (Jun 2022 – Sep 2025 · Malmö)
...
Technical Lead. Throughout the entire assignment she worked with both Java and Python in parallel —
approximately 50% Java (Spring Boot, Spring Security, backend services) and 50% Python (Django, platform
components) depending on the platform and task.

In the first two years she was part of the team working on the Dealer Platform and the Decisioning Engine.
She contributed to migrating legacy systems to a modern hexagonal architecture, and worked on complex logic
for fetching and matching loan terms from different banks based on credit score, risk profile and location.
She was a contributor on this team — not the lead. Never say she led the decisioning system or the
hexagonal architecture work.

In her final year she became Technical Lead for the Partner Platform — a product she herself designed and
built from scratch. The product attracted significant interest from Octane's external partners who wanted
to integrate it into their own websites. As Tech Lead she owned the full process: technical design,
development, and customization of the product adapted to each partner's branding and specific requirements.
She was the direct point of contact for external partners and led the technical onboarding end-to-end.
She shortened partner onboarding time through clear technical guidelines and tailored integration solutions.
...
### 4. Tedsys / Lagerkoll - Fullstack Developer (Sep 2020 – May 2022 · Malmö)
...
### 5. Gualda Comunicaciones - Developer (Jan 2018 – Jul 2020 · Logroño, Spain)
...
**Anthropic Academy:**
- **AI Fluency: Framework & Foundations** *(2026)* - Advanced competency in practical human-machine collaboration focused on efficiency and ethics. Proficiency in the 4D framework: strategic delegation, precise instruction formulation, critical evaluation of results, and responsible implementation. Specialized in advanced interaction with large-scale language models (LLM) to optimize workflows and increase productivity.
- **AI Capabilities and Limitations** *(2026)* - Comprehensive course on technical architecture and operational frameworks for AI. Analyzes performance boundaries of modern models including data quality, algorithmic limitations, hallucinations and bias. Focuses on risk management, ethics and technical prerequisites for safe and effective AI implementation in complex environments.
- **Claude 101 Course and Certification** *(2026)* - Technical deep-dive on Claude's architecture and functionality. Focuses on advanced prompt engineering, large context window management and workflow optimization. Special emphasis on safety protocols (Constitutional AI), integration of Claude into business processes and methods for reducing noise and increasing precision in generated responses.
- **Introduction to Claude Cowork** *(2026)* - Implementation and configuration of Claude's collaboration platforms for teams. Covers technical setup of shared workspaces (Projects), knowledge base management via document upload, and optimization of collaborative prompt strategies. Access control, custom instructions for consistent tone and quality, and practical use of Claude as a virtual colleague in agile workflows.
- **Building with the Claude API** - Technical competency in building applications using the Claude API. Covers SDK integration, tool use, prompt caching and production deployment patterns.
...
- **AI integration & implementation (TOP PROFILE):**
  ...
  Certified: Anthropic Academy (5 certifications including AI Fluency, Claude 101, Building with Claude API) + GenAI Level 2.
